...
<body style="background: #f7f7f7" class="dash">
    ...
    <div class="modal fade" data-bs-backdrop="static" id="open-image-selector-modal" data-bs-keyboard="false"
    ...
    <div class="col-12 d-flex">
        ...
        <div style="width: 280px;background: #11233b;min-height: 100vh;position: fixed;z-index: 100"
            class="aside active">
            ...
            <div class="col-12 px-0 py-5 text-center justify-content-center align-items-center ">
                <a href="{{ route('admin.profile.edit') }}">
                    <img src="{{ asset('storage' .'/' .auth()->user()->getUserAvatar()) }}"
                        style="width: 55px;height: 55px;color: #fff;border-radius: 50%" class="d-inline-block">
                </a>
            ...
            <div class="col-12 px-0">
                <div class="col-12 px-0">
                    ...
                    <a href="{{ route('admin.exams') }}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex ">
                            <div style="width: 50px" class="px-3 text-center">
                    ...
                    <a href="{{ route('admin.questions') }}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex ">
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-pen font-3"> </span>
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                المسائل
                            </div>
                    ...
                    <a href="{{ route('admin.tools') }}" class="col-12 px-0">
                        <div class="col-12 item px-0 d-flex ">
                            <div style="width: 50px" class="px-3 text-center">
                                <span class="fal fa-tools font-3"> </span>
                            </div>
                            <div style="width: calc(100% - 50px)" class="px-2">
                                الأدوات
                            </div>
        ...
        <div class="main-content in-active" style="overflow: hidden;">
            <div class="col-12 px-0 d-flex justify-content-between top-nav"
                style="height: 60px;box-shadow: 0px 0px 12px #f1f1f1;background: #fff;position: fixed;width: 100%;width: calc(100% - 280px);z-index: 1;">
                ...
                <div class="col-12 px-0 d-flex justify-content-end  " style="height: 60px;">
                    <div class="btn-group" id="notificationDropdown">
                        ...
                        <div class="col-12 px-0 d-flex justify-content-center align-items-center btn btn-light "
                            style="width: 60px;height: 60px;" data-bs-toggle="dropdown" aria-expanded="false"
                            id="dropdown-notifications">
                            <span class="fas fa-bell font-4 d-inline-block"
                                style="color: #ff9800;transform: rotate(15deg)"></span>
                            <span
                    ...
                    <div class="col-12 px-0 d-flex justify-content-center align-items-center  dropdown"
                        style="width: 60px;height: 60px;">
                        <div style="width: 60px;height: 60px;" data-bs-toggle="dropdown" aria-expanded="false"
                            class="d-flex justify-content-center align-items-center cursor-pointer">
                            <img src="{{ asset('storage' .'/' .auth()->user()->getUserAvatar()) }}"
                                style="padding: 10px;border-radius: 50%;width: 60px;height: 60px;">
                        </div>
